...
/* harmony import */ var _post_news_post_news_content__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./post-news/post-news-content */ "./src/components/post-news/post-news-content.js");
/* harmony import */ var _post_news_post_news_content__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_post_news_post_news_content__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _hamburgerOld_hamburgerOld_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hamburgerOld/hamburgerOld.js */ "./src/components/hamburgerOld/hamburgerOld.js");
/* harmony import */ var _hamburgerOld_hamburgerOld_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_hamburgerOld_hamburgerOld_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _mainFunction_mainFunction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mainFunction/mainFunction */ "./src/components/mainFunction/mainFunction.js");
/* harmony import */ var _mainFunction_mainFunction__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_mainFunction_mainFunction__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _lazy_load_lazy_load__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lazy-load/lazy-load */ "./src/components/lazy-load/lazy-load.js");
/* harmony import */ var _lazy_load_lazy_load__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_lazy_load_lazy_load__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _dynamicAdapt_dynamicAdapt_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dynamicAdapt/dynamicAdapt.js */ "./src/components/dynamicAdapt/dynamicAdapt.js");
/* harmony import */ var _dynamicAdapt_dynamicAdapt_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_dynamicAdapt_dynamicAdapt_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _sliderSwiper_sliderSwiper_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sliderSwiper/sliderSwiper.js */ "./src/components/sliderSwiper/sliderSwiper.js");
/* harmony import */ var _sliderSwiper_sliderSwiper_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_sliderSwiper_sliderSwiper_js__WEBPACK_IMPORTED_MODULE_6__);
// Form
// import './form/form'
// header
 // post-news-content
...
/***/ "./src/components/hamburgerOld/hamburgerOld.js":
/*!*****************************************************!*\
  !*** ./src/components/hamburgerOld/hamburgerOld.js ***!
  \*****************************************************/
/***/ (() => {
...
var headerTopParrentElement = document.querySelector('.header__top');
...
if (iconMenu != null) {
  ...
  iconMenu.addEventListener("click", function (e) {
    if (unlock) {
      ...
      headerTopParrentElement.classList.toggle("_active");
    }
  });
}
...
function menu_close() {
  ...
  headerTopParrentElement.classList.add("_active");
} //BodyLock
...
function switchIcon(arrayIcons) {
  for (var index = 0; index < arrayIcons.length; index++) {
...
if (moreBlocks.length > 0) {
  (function () {
    ...
    var _loop = function _loop(index) {
      var moreBlock = moreBlocks[index];
      ...
      if (items.length > 0) {
        var setSize = function setSize(type) {
          ...
          for (var _index = 0; _index < items.length; _index++) {
            if (_index < itemsView) {
              itemsContentHeight += items[_index].offsetHeight;
            }

            itemsContentStartHeight += items[_index].offsetHeight;
          }
    ...
    for (var index = 0; index < moreBlocks.length; index++) {
      _loop(index);
    }
  })();
} //========================================
...
/***/ "./src/components/post-news/post-news-content.js":
/*!*******************************************************!*\
  !*** ./src/components/post-news/post-news-content.js ***!
  \*******************************************************/
/***/ (() => {
...
if (document.querySelector('.links-share')) {
  ...
  var buttonLinkShare = document.querySelector('.links-share');
  var linksList = document.querySelector('.links-share__list');
  ...
  var adBlockRightSideContent = document.querySelector('.main__ad-block_right-side').children;
...
if (document.querySelector('.post-news__comments')) {
  ...
  var buttonComments = document.querySelector('.post-news__comments');
  var commentsBlock = document.querySelector('.post-news__comments-vk');
...
function sliders_bild_callback(params) {} // cлайдер Автоновости на главной странице


if (document.querySelector('.slider__autonews')) {
  var slider_main_autonews = new Swiper('.slider__autonews', {
    autoHeight: true,
    slidesPerGroup: 1,
    observer: true,
    observeParents: true,
...
if (document.querySelector('.slider__incident')) {
  var slider_main_incident = new Swiper('.slider__incident', {
    autoHeight: true,
    slidesPerGroup: 1,
    observer: true,
    observeParents: true,
...
if (document.querySelector('.slider__good-news')) {
  var slider_main_goodNews = new Swiper('.slider__good-news', {
    autoHeight: true,
    slidesPerGroup: 1,
    observer: true,
    observeParents: true,
...
if (document.querySelector('.slider-post__slider_first')) {
  var slider_post_first = new Swiper('.slider-post__slider_first', {
...
if (document.querySelector('.slider-post__slider_second')) {
  var _slider_post_first = new Swiper('.slider-post__slider_second', {
    // Эффекты переключения слайдов:
    // Смена прозрачности
    effect: "fade",
    // Дополнения к "fade"
...
/***/ "./src/vendor/enquire/enquire.min.js":
/*!*******************************************!*\
  !*** ./src/vendor/enquire/enquire.min.js ***!
  \*******************************************/
 ...
 * License: MIT */
!function (a) {
  if ("object" == (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) && "undefined" != "object") module.exports = a();else if ("function" == typeof define && __webpack_require__.amdO) define([], a);else {
    var b;
    b = "undefined" != typeof window ? window : "undefined" != typeof __webpack_require__.g ? __webpack_require__.g : "undefined" != typeof self ? self : this, b.enquire = a();
  }
}(function () {
  return function a(b, c, d) {
    ...
    for (var f = undefined, g = 0; g < d.length; g++) {
      e(d[g]);
    }
...
/* harmony import */ var _enquire_enquire_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./enquire/enquire.min.js */ "./src/vendor/enquire/enquire.min.js");
 // swiper slider

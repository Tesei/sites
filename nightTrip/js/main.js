...
// import { _removeClasses } from '../mainFunction/mainFunction'
// AboutUS
// Change the vision of persona
var imgWrapArr = document.querySelectorAll('.photo-about__image-wrap');
var personaVision = changePesonaVision(-1);
var cursorWithoutThePersonAreas = true;
personaVision();

function changePesonaVision(numberOfPersona) {
  var index = numberOfPersona;
  return function () {
    if (index < imgWrapArr.length - 1) {
      for (var _index = 0; _index < imgWrapArr.length; _index++) {
        var _element = imgWrapArr[_index];
        removeClassActive(_element);
      }

      index++;
      var element = imgWrapArr[index];

      if (cursorWithoutThePersonAreas) {
        addClassActive(imgWrapArr[index]);
        setTimeout(personaVision, 3000);
      }
    } else {
      removeClassActive(imgWrapArr[index]);
      index = -1;
      setTimeout(personaVision, 1500);
    }
  };
}
...
} // check the cursor on persons area


var personsArea = document.querySelector('.photo-about__images-row');
personsArea.addEventListener("mouseenter", function (event) {
  cursorWithoutThePersonAreas = false;
});
personsArea.addEventListener("mouseleave", function (event) {
  cursorWithoutThePersonAreas = true;
  personaVision();
}); // ========================================================================
...
/* harmony import */ var _aboutUs_aboutUs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./aboutUs/aboutUs */ "./src/components/aboutUs/aboutUs.js");
/* harmony import */ var _aboutUs_aboutUs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_aboutUs_aboutUs__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _formsOld_formsOld__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./formsOld/formsOld */ "./src/components/formsOld/formsOld.js");
/* harmony import */ var _sliderSwiper_sliderSwiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sliderSwiper/sliderSwiper */ "./src/components/sliderSwiper/sliderSwiper.js");
/* harmony import */ var _sliderSwiper_sliderSwiper__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_sliderSwiper_sliderSwiper__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _scroll_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scroll/scroll */ "./src/components/scroll/scroll.js");
/* harmony import */ var _lazy_load_lazy_load__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lazy-load/lazy-load */ "./src/components/lazy-load/lazy-load.js");
/* harmony import */ var _lazy_load_lazy_load__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_lazy_load_lazy_load__WEBPACK_IMPORTED_MODULE_5__);
...
function addClassActiveTimer(item, time) {
  setTimeout(function () {
    item.classList.toggle('_active');
  }, time);
}
...
menuButton.addEventListener("click", function (e) {
  if (arrLinks[0].classList.contains('_active')) {
    for (var index = arrLinks.length - 1; index >= 0; index--) {
      var element = arrLinks[index];
      addClassActiveTimer(element, (index - 4) * -1 * 200);
    }
  } else {
    for (var _index = 0; _index < arrLinks.length; _index++) {
...
/***/ "./src/components/lazy-load/lazy-load.js":
/*!***********************************************!*\
  !*** ./src/components/lazy-load/lazy-load.js ***!
  \***********************************************/
/***/ (() => {

// План создания ленивой загрузки
// 1. Оболочке изображения или скрываемого нами блока присваиваем класс ._wrap-to-animation с фоном колеса загрузки.
// 1.1 Ниже изображения создаём на том же уровне импорт фона.Фоном может служить блок с CSS анимацией под названием include../ lazy - load / lazy - load
// Или присваиваем стиль background: url('../images/loading.gif') center / 50px no-repeat;
// 2. Добавляем изображениям аттрибут data-src со значением места нахождения картинки.
// 3. добавляем изображению путь к картинке 1х1px PNG формата, с прозрачностью, у src аттрибута
// 4. В оболочку карты добавляем атрибут data-map со значением ссылки на карту (значение "src" iframe карты). Идобавляем технический клас для оболочки. Блок самой карты можно удалить.
// 5. В конструкции picture/source/ Указываем аттрибут data-srcset c указанием места нахождения изображения. Так же аттрибуту srcset указываем значение - путь к картинке 1х1px PNG формата, с прозрачностью
// 6. ПРИМЕР img(src="imagesNative/1x1clear.png", data-src="images/grid/cover-image-300x200.webp", alt="alt")
// 7. Видео инструкция https://www.youtube.com/watch?v=IdUbsiQUxa4 и https://www.youtube.com/watch?v=-2kzokozC7E
// Lazy Load function
var lazyImages = document.querySelectorAll('img[data-src],source[data-srcset]'); // Определяем высоту окна просмотра

var windowHeight = document.documentElement.clientHeight; // let loadMapBlock = document.querySelector('.техКлассКарты');
...
//                 "beforeend",
//                 `<ifame src="${loadMapUrl}" style ="border:0;" allowfullScreeen="" loading="lazy"></ifame>`
//             );
...
if (location.hash) {
  ...
  if (document.querySelector('.popup_' + hsh)) {
    ...
    _goto(document.querySelector('.' + hsh), 200, '');
  }
} //========================================
//RemoveClasses
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mainFunction_mainFunction__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mainFunction/mainFunction */ "./src/components/mainFunction/mainFunction.js");
/* harmony import */ var _mainFunction_mainFunction__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_mainFunction_mainFunction__WEBPACK_IMPORTED_MODULE_0__);
// scroll

var scr_body = document.querySelector('body');
var scr_blocks = document.querySelectorAll('._scr-sector'); // класс _scr-item добавляет блоку класс _active При просмотре блока юзером
...
if (scr_blocks.length > 0 && !_mainFunction_mainFunction__WEBPACK_IMPORTED_MODULE_0___default().any()) {
  disableScroll();
...
if (document.querySelector('.trip__slider.slider')) {
  var tripSlider = new Swiper('.trip__slider.slider', {
    autoplay: {
      delay: 6000,
    ...
    // Arrows
    navigation: {
      nextEl: '.slider__control-btn_column-right',
      prevEl: '.slider__control-btn_column-left'
    },
    // And if we need bullets
    pagination: {
      el: '.trip__pagination-shadow',
      clickable: true,
      renderBullet: function renderBullet(index) {
        var sliderItemsNamesArr = ['Chill Adventure', "Spooky Times", "Desert Madness", "Out in the wild"];
        return '<span class="trip__slide-name swiper-pagination-bullet">' + sliderItemsNamesArr[index] + "</span>";
        ++index;
      }
    },
 ...
 */
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) && "undefined" != "object" ? module.exports = t() : "function" == typeof define && __webpack_require__.amdO ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).Swiper = t();
}(undefined, function () {
  "use strict";
  ...
  function a(e) {
    return null !== e && "object" == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(e) && "constructor" in e && e.constructor === Object;
  }
  ...
  var Y = {
    ...
    slide: {
      slideTo: function slideTo(e, t, a, i) {
        if (void 0 === e && (e = 0), void 0 === t && (t = this.params.speed), void 0 === a && (a = !0), "number" != typeof e && "string" != typeof e) throw new Error("The 'index' argument cannot have type other than 'number' or 'string'. [" + _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(e) + "] given.");
    ...
    classes: {
      addClasses: function addClasses() {
        var e,
          ...
          "object" == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(e) ? Object.entries(e).forEach(function (e) {
            var i = e[0];
            e[1] && a.push(t + i);
    ...
    function t() {
      ...
      l.support = z(), l.device = P({
        ...
        if (t.params) {
          ...
          !0 === a[i] && (a[i] = {
            enabled: !0
          }), "object" != _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(a[i]) || "enabled" in a[i] || (a[i].enabled = !0), a[i] || (a[i] = {
            enabled: !1
          });
        }
      });
  ...
  var F = {
    ...
    appendSlide: function appendSlide(e) {
      var t = this;
      if ("object" == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(e) && "length" in e) for (var a = 0; a < e.length; a += 1) {
...
window.Element && !Element.prototype.closest && (Element.prototype.closest = function (e) {
  ...
  "function" == typeof define && __webpack_require__.amdO ? define([], function () {
    return t(e);
  }) : "object" == (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) ? module.exports = t(e) : e.SmoothScroll = t(e);
}("undefined" != typeof __webpack_require__.g ? __webpack_require__.g : "undefined" != typeof window ? window : undefined, function (q) {
  "use strict";
